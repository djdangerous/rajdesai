// Update 18/06/2015: Fixed CrossOrigin bug - Chrome.
// Update 05/02/2015: Better beat detection.
// Update 12/10/2014: Added sound bars and converted styling in SASS.
...
var SoundCloudAudioSource = function(player) {
  ...
  var SoundcloudLoader = function(player,uiUpdater) {
      var self = this;
      var client_id = "d39765567d5dcef2ad38799c6aa1b62d"; // to get an ID go to http://developers.soundcloud.com/
      this.sound = {};
      this.streamUrl = "";
      this.errorMessage = "";
      this.player = player;
    ...
    if (window.location.hash) {
      ...
      var trackUrl = 'https://soundcloud.com/' + 'housemusic2016/best-new-dubstep-2016-best-new-house-music-2016-edm-dj-dangerous-raj-desai-cruel-dubstep';
        loadAndUpdate(trackUrl);      
    }
